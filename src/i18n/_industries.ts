export const industries = {
  vi: {
    ...
    "ind.startup_desc": "Hàn Quốc cung cấp môi trường lý tưởng cho các doanh nghiệp khởi nghiệp với các chính sách hỗ trợ và quỹ đầu tư mạo hiểm dồi dào.",
    "ind.startup_btn": "TÌM HIỂU VỀ STARTUPS",
    
    // Tin tức
    "ind.news_item_1": "Hàn Quốc công bố lộ trình phát triển ngành Bán dẫn đến năm 2030",
    "ind.news_item_2": "Cơ hội đầu tư vào các cụm công nghiệp sinh học thế hệ mới",
  },
  ko: {
    "ind.title": "산업별 정보",
    "ind.news": "산업 뉴스",
