...
export const about = {
  vi: {
    "abt.title": "Giới thiệu",
    "abt.message": "Thông điệp của Tổng giám đốc KOTRA",
    "abt.ombudsman": "Thanh tra đầu tư nước ngoài",
    "abt.about": "Giới thiệu Invest KOREA",
    "abt.honorary": "Đại sứ quảng bá đầu tư nước ngoài",
    "abt.publication": "Ấn phẩm",
    "abt.magazine": "Tạp chí Invest KOREA",
    "abt.video": "Video quảng bá",
    "abt.media": "Truyền thông",
  },
  ko: {
    "abt.title": "INVEST KOREA 소개",
    "abt.message": "KOTRA 사장 인사말",
    "abt.ombudsman": "외국인투자 옴부즈만",
    "abt.about": "Invest KOREA 소개",
    "abt.honorary": "외국인투자 홍보대사",
    "abt.publication": "발간물",
    "abt.magazine": "Invest KOREA 매거진",
    "abt.video": "홍보 영상",
    "abt.media": "미디어",
  },
};
export const aboutData = {
  vi: {
    ...
    commissioner: {
      title: "Ủy viên trưởng Invest KOREA",
      name: "Kim Tae-hyung",
      quote: "Chìa khóa xây dựng một Hàn Quốc bền vững cho tương lai",
    ...
    intro: {
      ...
      highlight: "Hàn Quốc",
      desc: "Invest KOREA là nền tảng thu hút đầu tư nước ngoài.\nChúng tôi hỗ trợ bạn gia nhập thị trường Hàn Quốc.",
    },
  },
  ko: {
    pageTitle: "소개",
    commissioner: {
      title: "Invest KOREA 대표",
      name: "김태형",
      quote: "미래를 위한 지속 가능한 대한민국 건설의 열쇠",
    ...
    intro: {
      title: "비즈니스 기회의 땅",
      highlight: "대한민국",
      desc: "Invest KOREA는 외국인 투자 유치를 위한 플랫폼입니다.\n성공적인 한국 진출을 지원합니다.",
    },
  },
};
